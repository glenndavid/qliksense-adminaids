...
# Creates inbound and outbound firewall rules for a central node in multi-node Qlik Sense site 
#
#
# Glenn David
# 2019-09-01
...
Write-Host "This script creates firewall rules for a QSE central node"
...
New-NetFirewallRule -DisplayName "QlikSense Inbound" -Profile @('Domain', 'Private') -Direction Inbound -Action Allow -Protocol TCP -LocalPort @('80', '443', '4432', '4242', '4243', '4244', '4444','5050','5151','4747','4239','4949','4900','9028','4899')
